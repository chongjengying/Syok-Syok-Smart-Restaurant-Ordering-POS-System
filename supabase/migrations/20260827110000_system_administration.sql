...
begin
 ...
 delete from public.kitchen_station_categories where station_id is not null;
 delete from public.kitchen_stations where id is not null;
 delete from public.printer_configs where id is not null;

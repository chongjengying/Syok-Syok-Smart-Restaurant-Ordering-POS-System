...
export function translateStatus(language, status) {
  ...
  const labels = {
    en: { DRAFT: 'Draft', CONFIRMED: 'Confirmed', SUBMITTED: 'Submitted', PENDING: 'Pending', PREPARING: 'Preparing', READY: 'Ready', SERVED: 'Served', COMPLETED: 'Completed', CANCELLED: 'Cancelled', UNPAID: 'Unpaid', PAID: 'Paid', AVAILABLE: 'Available', OCCUPIED: 'Occupied', RESERVED: 'Reserved', CLEANING: 'Cleaning', DISABLED: 'Disabled' },
    zh: { DRAFT: '草稿', CONFIRMED: '已确认', SUBMITTED: '已提交', PENDING: '等待中', PREPARING: '制作中', READY: '已备妥', SERVED: '已上菜', COMPLETED: '已完成', CANCELLED: '已取消', UNPAID: '未付款', PAID: '已付款', AVAILABLE: '可用', OCCUPIED: '使用中', RESERVED: '已预留', CLEANING: '清洁中', DISABLED: '已停用' },
    ms: { DRAFT: 'Draf', CONFIRMED: 'Disahkan', SUBMITTED: 'Dihantar', PENDING: 'Menunggu', PREPARING: 'Sedang Disediakan', READY: 'Sedia', SERVED: 'Dihidang', COMPLETED: 'Selesai', CANCELLED: 'Dibatalkan', UNPAID: 'Belum Dibayar', PAID: 'Dibayar', AVAILABLE: 'Tersedia', OCCUPIED: 'Diduduki', RESERVED: 'Ditempah', CLEANING: 'Pembersihan', DISABLED: 'Dilumpuhkan' },
  };

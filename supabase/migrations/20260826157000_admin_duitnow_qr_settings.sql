...
revoke all on function public.update_manual_qr_payment_settings(boolean,text,text) from public,anon;
grant execute on function public.update_manual_qr_payment_settings(boolean,text,text) to authenticated;

...
Object.assign(translations.en, {
  registerTab: 'REGISTER', loginRequired: 'Please enter both email and password.', nameRequired: 'Please enter your name.', passwordLength: 'Password must be at least 8 characters long.', accountCreated: 'Registration successful. Check your email to confirm the account, then wait for administrator activation.', unexpectedRetry: 'An unexpected error occurred. Please try again.',
  emailRequired: 'Please enter your email address.', confirmPassword: 'Confirm Password', passwordMismatch: 'Passwords do not match.', forgotPassword: 'Forgot password?', forgotPasswordTitle: 'Reset Your Password', forgotPasswordSubtitle: 'We will email you a secure reset link', sendResetLink: 'SEND RESET LINK', passwordResetSent: 'If an account exists for this email, a reset link has been sent.', backToSignIn: 'Back to sign in', resendConfirmation: 'Resend confirmation email', confirmationResent: 'Confirmation email sent. Please check your inbox.', resetPasswordTitle: 'Choose a New Password', resetPasswordSubtitle: 'Enter and confirm your new password', updatePassword: 'UPDATE PASSWORD', passwordUpdated: 'Password updated successfully.', sending: 'Sending…',
  staffPendingActivation: 'Registration successful. Your email account is valid, but POS access is awaiting administrator activation.', staffAccessDisabled: 'This staff account is {status}. Contact an administrator for assistance.',
  staffAccounts: 'Staff Accounts', staffAccountsHelp: 'Review registration status, assign roles, and control terminal access.', staffLoadFailed: 'Unable to load staff accounts.', staffSaveFailed: 'Unable to update staff access.', staffAccessSaved: 'Staff access updated successfully.', noStaffAccounts: 'No staff accounts found.', unnamedStaff: 'Unnamed staff', you: 'YOU', adminStaffSecurityNotice: 'Only administrators can change staff roles and account status. Your own access cannot be changed here.',
...
Object.assign(translations.zh, {
  registerTab: '注册', loginRequired: '请输入电子邮件和密码。', nameRequired: '请输入姓名。', passwordLength: '密码必须至少为 8 个字符。', accountCreated: '注册成功。请检查电子邮件并确认账户，然后等待管理员启用。', unexpectedRetry: '发生意外错误，请重试。',
  emailRequired: '请输入电子邮件。', confirmPassword: '确认密码', passwordMismatch: '两次输入的密码不一致。', forgotPassword: '忘记密码？', forgotPasswordTitle: '重置密码', forgotPasswordSubtitle: '我们会发送安全的重置链接到您的邮箱', sendResetLink: '发送重置链接', passwordResetSent: '如果该邮箱存在账户，重置链接已发送。', backToSignIn: '返回登录', resendConfirmation: '重新发送确认邮件', confirmationResent: '确认邮件已发送，请检查收件箱。', resetPasswordTitle: '设置新密码', resetPasswordSubtitle: '输入并确认新密码', updatePassword: '更新密码', passwordUpdated: '密码更新成功。', sending: '发送中…',
  staffPendingActivation: '注册成功。您的邮箱账户有效，但 POS 访问权限仍待管理员启用。', staffAccessDisabled: '此员工账户状态为 {status}。请联系管理员。',
  staffAccounts: '员工账户', staffAccountsHelp: '检查注册状态、分配角色并管理终端访问。', staffLoadFailed: '无法加载员工账户。', staffSaveFailed: '无法更新员工权限。', staffAccessSaved: '员工权限已成功更新。', noStaffAccounts: '没有员工账户。', unnamedStaff: '未命名员工', you: '本人', adminStaffSecurityNotice: '只有管理员可以更改员工角色和账户状态，不能在此修改自己的权限。',
...
Object.assign(translations.ms, {
  registerTab: 'DAFTAR', loginRequired: 'Sila masukkan e-mel dan kata laluan.', nameRequired: 'Sila masukkan nama anda.', passwordLength: 'Kata laluan mestilah sekurang-kurangnya 8 aksara.', accountCreated: 'Pendaftaran berjaya. Sahkan akaun melalui e-mel, kemudian tunggu pengaktifan pentadbir.', unexpectedRetry: 'Ralat tidak dijangka berlaku. Sila cuba lagi.',
  emailRequired: 'Sila masukkan alamat e-mel.', confirmPassword: 'Sahkan Kata Laluan', passwordMismatch: 'Kata laluan tidak sepadan.', forgotPassword: 'Lupa kata laluan?', forgotPasswordTitle: 'Tetapkan Semula Kata Laluan', forgotPasswordSubtitle: 'Kami akan menghantar pautan selamat melalui e-mel', sendResetLink: 'HANTAR PAUTAN', passwordResetSent: 'Jika akaun wujud untuk e-mel ini, pautan tetapan semula telah dihantar.', backToSignIn: 'Kembali ke log masuk', resendConfirmation: 'Hantar semula e-mel pengesahan', confirmationResent: 'E-mel pengesahan dihantar. Sila semak peti masuk.', resetPasswordTitle: 'Pilih Kata Laluan Baharu', resetPasswordSubtitle: 'Masukkan dan sahkan kata laluan baharu', updatePassword: 'KEMAS KINI KATA LALUAN', passwordUpdated: 'Kata laluan berjaya dikemas kini.', sending: 'Menghantar…',
  staffPendingActivation: 'Pendaftaran berjaya. Akaun e-mel anda sah, tetapi akses POS masih menunggu pengaktifan pentadbir.', staffAccessDisabled: 'Akaun kakitangan ini berstatus {status}. Hubungi pentadbir untuk bantuan.',
  staffAccounts: 'Akaun Kakitangan', staffAccountsHelp: 'Semak status pendaftaran, tetapkan peranan dan kawal akses terminal.', staffLoadFailed: 'Akaun kakitangan tidak dapat dimuatkan.', staffSaveFailed: 'Akses kakitangan tidak dapat dikemas kini.', staffAccessSaved: 'Akses kakitangan berjaya dikemas kini.', noStaffAccounts: 'Tiada akaun kakitangan.', unnamedStaff: 'Kakitangan tanpa nama', you: 'ANDA', adminStaffSecurityNotice: 'Hanya pentadbir boleh menukar peranan dan status akaun. Akses anda sendiri tidak boleh diubah di sini.',
...
Object.assign(translations.en, {
  systemLogoHelp: 'PNG, JPEG, or WebP · maximum 5 MB. Logo failure never blocks POS operation.', systemLogoPreview: 'Restaurant logo preview', systemNoLogo: 'No logo configured', systemUploadReplace: 'Upload / Replace', remove: 'Remove', systemApplicableOrderTypes: 'Applicable Order Types', systemFinancialSnapshotHelp: 'Rates and currency are snapshotted onto each order. Existing paid/completed transactions are never recalculated.', systemTestPrint: 'Test Print', systemAddPrinter: 'Add Printer', systemPrinter: 'Printer', none: 'None', systemCategoriesAssigned: 'Categories Assigned', systemRemoveStation: 'Remove station', systemAddStation: 'Add Station', systemRoutingHelp: 'Routing uses product categories and never clones order items or kitchen batches.', systemNumberingHelp: 'Numbers are issued atomically by PostgreSQL. Issued, cancelled, and refunded numbers are never reused.', systemBackupAuthorityHelp: 'Backups are externally managed. Success is shown only when an authoritative backup record exists in System Health.', systemTestConnection: 'Test Connection', systemSecretsHelp: 'Secrets are server-side only. This page never accepts or returns full credentials.',
  posDashboard: 'POS Dashboard', closeNavigation: 'Close navigation', adminGroupOPERATIONS: 'OPERATIONS', adminGroupCATALOG: 'CATALOG', adminGroupMANAGEMENT: 'MANAGEMENT', adminGroupSYSTEM: 'SYSTEM', adminNav_dashboard: 'Dashboard', adminNav_orders: 'Orders', adminNav_payments: 'Payments', adminNav_tables: 'Tables', adminNav_products: 'Products', adminNav_categories: 'Categories', adminNav_inventory: 'Inventory', adminNav_users: 'Users', adminNav_roles: 'Roles & Permissions', adminNav_reports: 'Reports', adminNav_systemAdministration: 'System Administration', adminNav_systemHealth: 'System Health', adminNav_audit: 'Audit Logs', adminNav_qrSettings: 'DuitNow QR',
  'adminNav_system-administration': 'System Administration', 'adminNav_system-health': 'System Health', 'adminNav_qr-settings': 'DuitNow QR',
  inventory: 'Inventory', inventoryHelp: 'Branch stock levels and immutable movement history.', branch: 'Branch', search: 'Search', lowStockOnly: 'Low stock only', lowStock: 'Low stock', onHand: 'On hand', reorderLevel: 'Reorder level', adjustStock: 'Adjust stock', noInventory: 'No inventory items found.', movementType: 'Movement type', quantityDelta: 'Quantity change', reason: 'Reason', confirm: 'Confirm', inventoryInvalidAdjustment: 'Enter a non-zero quantity and a reason of at least 3 characters.',
  adminMenu: 'Admin menu', adminOffline: 'You are offline. Changes are paused until the connection returns.', adminReconnecting: 'Connection restored. Reconnecting to live services…',
  pagination: 'Pagination', previous: 'Previous', next: 'Next', pageOf: 'Page {page} of {total}',
  systemAdministration: 'SYSTEM ADMINISTRATION', restaurantConfiguration: 'Restaurant Configuration', systemEnvironment: 'Environment', systemRevision: 'Revision', systemAdminEdit: 'ADMIN EDIT', systemReadOnly: 'READ ONLY', systemProductionWarning: 'PRODUCTION CONFIGURATION — changes affect future transactions and devices.',
  systemTabGeneral: 'General', systemTabBranding: 'Branding', systemTabTaxCharges: 'Tax & Charges', systemTabReceipt: 'Receipt', systemTabPrinter: 'Printer', systemTabKitchen: 'Kitchen / KDS', systemTabNumbering: 'Numbering', systemTabRegional: 'Regional', systemTabBackup: 'Backup', systemTabIntegrations: 'Integrations',
  systemTimezone: 'IANA Timezone', systemCurrencyCode: 'Currency Code', systemCurrencySymbol: 'Currency Symbol', systemDecimalPlaces: 'Decimal Places', systemRoundingRule: 'Rounding Rule', systemDefaultLanguage: 'Default Language', systemEnabledLanguages: 'Enabled Languages', systemLanguage_en: 'English', systemLanguage_zh: 'Simplified Chinese', systemLanguage_ms: 'Bahasa Melayu', systemDefault: 'default', systemLanguageHelp: 'Only enabled languages appear on POS language selectors. Change the default language before disabling it.',
  systemUnsavedChanges: 'Unsaved changes', systemTabUnsaved: 'You have unsaved changes in {tab}.', systemTabCurrent: '{tab} settings are up to date.', systemBackupReadOnly: 'Backup details are managed externally and are read only.', systemResetTab: 'Reset {tab}', systemSaveTab: 'Save {tab}', systemUnsavedTabsHelp: 'Unsaved tabs are marked with an amber dot. Save each tab separately before leaving.', retry: 'Retry',
});
Object.assign(translations.zh, {
  systemLogoHelp: '支持 PNG、JPEG 或 WebP，最大 5 MB。标志载入失败不会阻断 POS 营运。', systemLogoPreview: '餐厅标志预览', systemNoLogo: '尚未设置标志', systemUploadReplace: '上传／替换', remove: '移除', systemApplicableOrderTypes: '适用订单类型', systemFinancialSnapshotHelp: '每张订单都会保存当时的费率与货币，已付款或已完成交易绝不重新计算。', systemTestPrint: '测试打印', systemAddPrinter: '新增打印机', systemPrinter: '打印机', none: '无', systemCategoriesAssigned: '已分配分类', systemRemoveStation: '移除工作站', systemAddStation: '新增工作站', systemRoutingHelp: '路由依照商品分类处理，不会复制订单商品或厨房批次。', systemNumberingHelp: '编号由 PostgreSQL 原子签发；已签发、取消或退款的编号绝不重复使用。', systemBackupAuthorityHelp: '备份由外部系统管理；只有 System Health 存在权威记录时才显示成功。', systemTestConnection: '测试连接', systemSecretsHelp: '密钥只在服务器配置，本页面不会接收或返回完整凭证。',
  posDashboard: 'POS 主面板', closeNavigation: '关闭导航', adminGroupOPERATIONS: '营运', adminGroupCATALOG: '商品目录', adminGroupMANAGEMENT: '管理', adminGroupSYSTEM: '系统', adminNav_dashboard: '总览', adminNav_orders: '订单', adminNav_payments: '付款', adminNav_tables: '餐桌', adminNav_products: '商品', adminNav_categories: '分类', adminNav_inventory: '库存', adminNav_users: '用户', adminNav_roles: '角色与权限', adminNav_reports: '报表', adminNav_systemAdministration: '系统管理', adminNav_systemHealth: '系统健康', adminNav_audit: '审计日志', adminNav_qrSettings: 'DuitNow 二维码',
  'adminNav_system-administration': '系统管理', 'adminNav_system-health': '系统健康', 'adminNav_qr-settings': 'DuitNow 二维码',
  inventory: '库存管理', inventoryHelp: '查看各分店库存及不可篡改的库存变动记录。', branch: '分店', search: '搜索', lowStockOnly: '只显示低库存', lowStock: '低库存', onHand: '现有库存', reorderLevel: '补货警戒线', adjustStock: '调整库存', noInventory: '没有库存记录。', movementType: '变动类型', quantityDelta: '数量变化', reason: '原因', confirm: '确认', inventoryInvalidAdjustment: '请输入非零数量及至少 3 个字符的原因。',
  adminMenu: '管理菜单', adminOffline: '目前处于离线状态。恢复连接前不会提交任何更改。', adminReconnecting: '网络已恢复，正在重新连接实时服务…',
  pagination: '分页导航', previous: '上一页', next: '下一页', pageOf: '第 {page} 页，共 {total} 页',
  systemAdministration: '系统管理', restaurantConfiguration: '餐厅系统配置', systemEnvironment: '环境', systemRevision: '版本', systemAdminEdit: '管理员可编辑', systemReadOnly: '只读', systemProductionWarning: '生产环境配置——更改将影响之后的交易和设备。',
  systemTabGeneral: '基本资料', systemTabBranding: '品牌', systemTabTaxCharges: '税务与服务费', systemTabReceipt: '收据', systemTabPrinter: '打印机', systemTabKitchen: '厨房 / KDS', systemTabNumbering: '编号规则', systemTabRegional: '区域与语言', systemTabBackup: '备份', systemTabIntegrations: '集成服务',
  systemTimezone: 'IANA 时区', systemCurrencyCode: '货币代码', systemCurrencySymbol: '货币符号', systemDecimalPlaces: '小数位数', systemRoundingRule: '舍入规则', systemDefaultLanguage: '默认语言', systemEnabledLanguages: '启用的语言', systemLanguage_en: '英文', systemLanguage_zh: '简体中文', systemLanguage_ms: '马来文', systemDefault: '默认', systemLanguageHelp: 'POS 语言选择器只显示已启用的语言。若要停用当前默认语言，请先更换默认语言。',
  systemUnsavedChanges: '未保存的更改', systemTabUnsaved: '{tab}有尚未保存的更改。', systemTabCurrent: '{tab}设置已是最新。', systemBackupReadOnly: '备份资料由外部系统管理，仅供查看。', systemResetTab: '重置{tab}', systemSaveTab: '保存{tab}', systemUnsavedTabsHelp: '有未保存更改的分页会显示琥珀色圆点。离开前请分别保存每个分页。', retry: '重试',
});
Object.assign(translations.ms, {
  systemLogoHelp: 'PNG, JPEG atau WebP · maksimum 5 MB. Kegagalan logo tidak menyekat operasi POS.', systemLogoPreview: 'Pratonton logo restoran', systemNoLogo: 'Tiada logo dikonfigurasi', systemUploadReplace: 'Muat Naik / Ganti', remove: 'Alih Keluar', systemApplicableOrderTypes: 'Jenis Pesanan Berkenaan', systemFinancialSnapshotHelp: 'Kadar dan mata wang disimpan pada setiap pesanan. Transaksi dibayar atau selesai tidak dikira semula.', systemTestPrint: 'Uji Cetakan', systemAddPrinter: 'Tambah Pencetak', systemPrinter: 'Pencetak', none: 'Tiada', systemCategoriesAssigned: 'Kategori Ditugaskan', systemRemoveStation: 'Alih keluar stesen', systemAddStation: 'Tambah Stesen', systemRoutingHelp: 'Penghalaan menggunakan kategori produk dan tidak menyalin item pesanan atau kelompok dapur.', systemNumberingHelp: 'Nombor dikeluarkan secara atomik oleh PostgreSQL dan tidak pernah digunakan semula.', systemBackupAuthorityHelp: 'Sandaran diuruskan secara luaran. Kejayaan hanya dipaparkan apabila rekod berwibawa wujud dalam System Health.', systemTestConnection: 'Uji Sambungan', systemSecretsHelp: 'Rahsia hanya dikonfigurasi pada pelayan. Halaman ini tidak menerima atau memulangkan kelayakan penuh.',
  posDashboard: 'Papan Pemuka POS', closeNavigation: 'Tutup navigasi', adminGroupOPERATIONS: 'OPERASI', adminGroupCATALOG: 'KATALOG', adminGroupMANAGEMENT: 'PENGURUSAN', adminGroupSYSTEM: 'SISTEM', adminNav_dashboard: 'Papan Pemuka', adminNav_orders: 'Pesanan', adminNav_payments: 'Bayaran', adminNav_tables: 'Meja', adminNav_products: 'Produk', adminNav_categories: 'Kategori', adminNav_inventory: 'Inventori', adminNav_users: 'Pengguna', adminNav_roles: 'Peranan & Kebenaran', adminNav_reports: 'Laporan', adminNav_systemAdministration: 'Pentadbiran Sistem', adminNav_systemHealth: 'Kesihatan Sistem', adminNav_audit: 'Log Audit', adminNav_qrSettings: 'QR DuitNow',
  'adminNav_system-administration': 'Pentadbiran Sistem', 'adminNav_system-health': 'Kesihatan Sistem', 'adminNav_qr-settings': 'QR DuitNow',
  inventory: 'Inventori', inventoryHelp: 'Paras stok cawangan dan sejarah pergerakan yang tidak boleh diubah.', branch: 'Cawangan', search: 'Cari', lowStockOnly: 'Stok rendah sahaja', lowStock: 'Stok rendah', onHand: 'Stok semasa', reorderLevel: 'Paras pesanan semula', adjustStock: 'Laras stok', noInventory: 'Tiada rekod inventori.', movementType: 'Jenis pergerakan', quantityDelta: 'Perubahan kuantiti', reason: 'Sebab', confirm: 'Sahkan', inventoryInvalidAdjustment: 'Masukkan kuantiti bukan sifar dan sebab sekurang-kurangnya 3 aksara.',
  adminMenu: 'Menu pentadbir', adminOffline: 'Anda di luar talian. Perubahan dijeda sehingga sambungan kembali.', adminReconnecting: 'Sambungan dipulihkan. Menyambung semula perkhidmatan langsung…',
  pagination: 'Navigasi halaman', previous: 'Sebelumnya', next: 'Seterusnya', pageOf: 'Halaman {page} daripada {total}',
  systemAdministration: 'PENTADBIRAN SISTEM', restaurantConfiguration: 'Konfigurasi Restoran', systemEnvironment: 'Persekitaran', systemRevision: 'Semakan', systemAdminEdit: 'EDIT PENTADBIR', systemReadOnly: 'BACA SAHAJA', systemProductionWarning: 'KONFIGURASI PRODUKSI — perubahan akan menjejaskan transaksi dan peranti akan datang.',
  systemTabGeneral: 'Umum', systemTabBranding: 'Penjenamaan', systemTabTaxCharges: 'Cukai & Caj', systemTabReceipt: 'Resit', systemTabPrinter: 'Pencetak', systemTabKitchen: 'Dapur / KDS', systemTabNumbering: 'Penomboran', systemTabRegional: 'Wilayah & Bahasa', systemTabBackup: 'Sandaran', systemTabIntegrations: 'Integrasi',
  systemTimezone: 'Zon Waktu IANA', systemCurrencyCode: 'Kod Mata Wang', systemCurrencySymbol: 'Simbol Mata Wang', systemDecimalPlaces: 'Tempat Perpuluhan', systemRoundingRule: 'Peraturan Pembundaran', systemDefaultLanguage: 'Bahasa Lalai', systemEnabledLanguages: 'Bahasa Diaktifkan', systemLanguage_en: 'Bahasa Inggeris', systemLanguage_zh: 'Bahasa Cina Ringkas', systemLanguage_ms: 'Bahasa Melayu', systemDefault: 'lalai', systemLanguageHelp: 'Hanya bahasa yang diaktifkan dipaparkan pada pemilih bahasa POS. Tukar bahasa lalai sebelum menyahaktifkannya.',
  systemUnsavedChanges: 'Perubahan belum disimpan', systemTabUnsaved: 'Anda mempunyai perubahan belum disimpan dalam {tab}.', systemTabCurrent: 'Tetapan {tab} adalah terkini.', systemBackupReadOnly: 'Butiran sandaran diuruskan secara luaran dan hanya boleh dibaca.', systemResetTab: 'Tetap Semula {tab}', systemSaveTab: 'Simpan {tab}', systemUnsavedTabsHelp: 'Tab dengan perubahan belum disimpan ditandai titik ambar. Simpan setiap tab secara berasingan sebelum keluar.', retry: 'Cuba Lagi',
});
...
const systemLabels={
 'Restaurant Name':['Restaurant Name','餐厅名称','Nama Restoran'],'Legal Company Name':['Legal Company Name','公司法定名称','Nama Syarikat Sah'],'Registration Number':['Registration Number','公司注册号','Nombor Pendaftaran'],'Tax Registration Number':['Tax Registration Number','税务登记号','Nombor Pendaftaran Cukai'],'Phone Number':['Phone Number','电话号码','Nombor Telefon'],Email:['Email','电子邮件','E-mel'],Website:['Website','网站','Laman Web'],'Address Line 1':['Address Line 1','地址第一行','Alamat Baris 1'],'Address Line 2':['Address Line 2','地址第二行','Alamat Baris 2'],City:['City','城市','Bandar'],State:['State','州属','Negeri'],Postcode:['Postcode','邮政编码','Poskod'],Country:['Country','国家','Negara'],'Branch Name':['Branch Name','分店名称','Nama Cawangan'],'Branch Code':['Branch Code','分店代码','Kod Cawangan'],
 'Tax Enabled':['Tax Enabled','启用税项','Cukai Diaktifkan'],'Tax Name':['Tax Name','税项名称','Nama Cukai'],'Tax Rate (%)':['Tax Rate (%)','税率（%）','Kadar Cukai (%)'],'Tax Mode':['Tax Mode','税务模式','Mod Cukai'],'Service Charge Enabled':['Service Charge Enabled','启用服务费','Caj Perkhidmatan Diaktifkan'],'Service Charge Name':['Service Charge Name','服务费名称','Nama Caj Perkhidmatan'],'Service Charge Rate (%)':['Service Charge Rate (%)','服务费率（%）','Kadar Caj Perkhidmatan (%)'],
 'Show Logo':['Show Logo','显示标志','Papar Logo'],Address:['Address','地址','Alamat'],Phone:['Phone','电话','Telefon'],'Tax Number':['Tax Number','税号','Nombor Cukai'],'Order Number':['Order Number','订单编号','Nombor Pesanan'],'Table Number':['Table Number','桌号','Nombor Meja'],'Staff Name':['Staff Name','员工姓名','Nama Kakitangan'],'Payment Method':['Payment Method','付款方式','Kaedah Bayaran'],Tax:['Tax','税项','Cukai'],'Service Charge':['Service Charge','服务费','Caj Perkhidmatan'],Discount:['Discount','折扣','Diskaun'],'Item Notes':['Item Notes','商品备注','Nota Item'],'Auto Print':['Auto Print','自动打印','Cetak Automatik'],'Receipt Header':['Receipt Header','收据页首','Pengepala Resit'],'Receipt Footer':['Receipt Footer','收据页尾','Pengaki Resit'],'Thank You Message':['Thank You Message','感谢语','Mesej Terima Kasih'],Copies:['Copies','份数','Salinan'],'Paper Size':['Paper Size','纸张尺寸','Saiz Kertas'],
 'Printer Name':['Printer Name','打印机名称','Nama Pencetak'],Type:['Type','类型','Jenis'],Connection:['Connection','连接方式','Sambungan'],'Paper Width':['Paper Width','纸张宽度','Lebar Kertas'],'IP Address':['IP Address','IP 地址','Alamat IP'],Port:['Port','端口','Port'],'Auto Cut':['Auto Cut','自动切纸','Potong Automatik'],Enabled:['Enabled','已启用','Diaktifkan'],'Station Name':['Station Name','工作站名称','Nama Stesen'],'Station Code':['Station Code','工作站代码','Kod Stesen'],'Station Type':['Station Type','工作站类型','Jenis Stesen'],Printer:['Printer','打印机','Pencetak'],'KDS Device Key':['KDS Device Key','KDS 设备密钥','Kunci Peranti KDS'],Prefix:['Prefix','前缀','Awalan'],Padding:['Padding','补零位数','Pelapik'],'Date Format':['Date Format','日期格式','Format Tarikh'],Reset:['Reset','重置周期','Tetap Semula'],'Backup Mode':['Backup Mode','备份模式','Mod Sandaran'],Provider:['Provider','供应商','Penyedia'],Frequency:['Frequency','频率','Kekerapan'],Retention:['Retention','保留期限','Pengekalan']
};
export function translateSystemLabel(language,label){const values=systemLabels[label];return values?.[language==='zh'?1:language==='ms'?2:0]??label;}

...
const ERROR_MESSAGES = {
  ...
  PRODUCT_NOT_AVAILABLE_AT_BRANCH: 'This product is not available at the current branch.',
  PRODUCT_SOLD_OUT: 'This product is currently sold out. Refresh the menu and choose another item.',
  CATEGORY_NOT_AVAILABLE: 'This product category is no longer available.',
  INVALID_BRANCH_PRICE: 'This product does not have a valid selling price for the current branch.',
  ORDER_NOT_EDITABLE: 'This order can no longer be edited. Refresh the order to see its latest status.',
  ORDER_BRANCH_MISMATCH: 'This order belongs to a different branch and cannot be changed here.',
  ...
  INVALID_PAYMENT_AMOUNT: 'Enter a payment amount greater than zero and no more than the remaining balance.',
  PAYMENT_EXCEEDS_BALANCE: 'This payment exceeds the current remaining balance. Refresh the bill and try again.',
  INSUFFICIENT_CASH_RECEIVED: 'The cash received is less than the applied payment amount.',
  ITEM_ALLOCATIONS_REQUIRED: 'Select at least one unpaid item quantity.',
  ORDER_ITEM_NOT_FOUND: 'A selected order item is no longer available. Refresh the bill.',
  ORDER_ITEM_ALREADY_PAID: 'One of the selected item quantities has already been paid on another terminal.',
  ORDER_ITEM_ALLOCATED_TWICE: 'The same order item was included twice in this payment.',
  EQUAL_SPLIT_BILL_REQUIRED: 'Select the equal share being paid.',
  BILL_ALREADY_PAID: 'This split has already been paid. Refresh the bill.',
  ORDER_HAS_LEGACY_BILL_SPLIT: 'This order already has an equal split plan. Pay one of its remaining shares.',
  REPORT_DATE_RANGE_REQUIRED: 'Select both a start date and an end date for this report.',
  INVALID_DATE_RANGE: 'The report start date must not be after the end date.',
  REPORT_DATE_RANGE_TOO_LARGE: 'Select a report range of 366 days or less.',

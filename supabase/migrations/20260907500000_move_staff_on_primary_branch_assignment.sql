-- A primary assignment from Branch > Staff > Manage is a move. Keep history
-- by inactivating previous branch assignments rather than deleting them.
...
begin
  ...
  if p_is_primary then
    ...
    where staff_id=p_user_id and branch_id<>p_branch_id and status='ACTIVE';
  end if;

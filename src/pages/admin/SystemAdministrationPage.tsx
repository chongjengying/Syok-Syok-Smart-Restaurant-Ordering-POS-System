...
const activeLanguage = () =>
  document.documentElement.lang.startsWith("zh")
    ? "zh"
    : document.documentElement.lang.startsWith("ms")
      ? "ms"
      : "en";
function Field({
  label,
  ...
  return (
    <label className={labelClass}>
      {translateSystemLabel(activeLanguage(), label)}
      <input
        type={type}
        value={String(value ?? "")}
  ...
  return (
    <section className="space-y-5 pb-10">
      <header>
        ...
        <h1 className="text-3xl font-black">{tr("restaurantConfiguration")}</h1>
      ...
      >
          ...
          <div className="grid gap-5 md:grid-cols-2">
            <div className="space-y-3">
              ...
              <Select
                label="Tax Mode"
                value={s.taxMode}
                onChange={(v) => set("taxMode", v as SystemSettings["taxMode"])}
            ...
            {s.stations.map((station, index) => (
              ...
              >
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      set(
                        "stations",
                        s.stations.map((x, i) =>
                          i === index ? { ...x, printerId: e.target.value } : x,
                        ),
                      )
                    }
                  >
                ...
                <div className="md:col-span-3">
                  <p className={labelClass}>{tr("systemCategoriesAssigned")}</p>
                ...
                <Field
                  ...
                  onChange={(v) =>
                    set(
                      "numbering",
                      s.numbering.map((x, i) =>
                        i === index ? { ...x, sequencePadding: Number(v) } : x,
                      ),
                    )
                  }
                />
        ...
        <div className="mt-6 flex flex-wrap items-center justify-between gap-3 border-t pt-4">
          ...
          <div className="flex gap-2">
            ...
            <button
              type="button"
              disabled={disabled || !tabDirty || state.saving || !fields.length}
